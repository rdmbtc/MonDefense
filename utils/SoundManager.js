...
export default class SoundManager {
  ...
  preload() {
    try {
      // --- Sounds loaded by LoadingScene --- 
      console.log("SoundManager: Sounds already loaded by LoadingScene...");
      
      // Music
      this.scene.load.audio('bgm_gameplay', ['/SFX/bg_music.mp3']);
      
      // UI sounds
      this.scene.load.audio('click', ['/SFX/ui_click.mp3']);
      this.scene.load.audio('ui_click', ['/SFX/ui_click.mp3']); // Alias for click
      this.scene.load.audio('ui_click_confirm', ['/SFX/ui_click.mp3']); // Alias for click
      this.scene.load.audio('coins', ['/SFX/coins.mp3']);
      this.scene.load.audio('coin_gain', ['/SFX/coins.mp3']); // Alias for coins
      this.scene.load.audio('coin_spend', ['/SFX/coins.mp3']); // Alias for coins
      this.scene.load.audio('coin_collect_batch', ['/SFX/coins.mp3']); // Use coins.mp3 as fallback
      this.scene.load.audio('error', ['/SFX/ui_click.mp3']); // Use ui_click as fallback
      
      // Game sounds
      // Provide OGG as preferred format, MP3 as fallback for 'plant'
      this.scene.load.audio('plant', ['/SFX/ui_click.mp3']);
      this.scene.load.audio('harvest', ['/SFX/coins.mp3']); 
      this.scene.load.audio('enemy_hit', ['/SFX/enemy_hit.mp3']); 
      this.scene.load.audio('enemy_defeat', ['/SFX/enemy_defeat.mp3']); 
      this.scene.load.audio('enemy_escaped', ['/SFX/enemy_hit.mp3']);
      this.scene.load.audio('enemy_escaped_alarm', ['/SFX/enemy_hit.mp3']); // Use enemy_hit as fallback
      this.scene.load.audio('wave_start', ['/SFX/ui_click.mp3']); 
      this.scene.load.audio('wave_complete', ['/SFX/victory.mp3']); 
      
      // Defense sounds
      this.scene.load.audio('defense_placed', ['/SFX/ui_click.mp3']); 
      this.scene.load.audio('chog_attack', ['/SFX/fire_attack.mp3']); 
      this.scene.load.audio('molandak_attack', ['/SFX/fire_attack.mp3']); 
      this.scene.load.audio('keon_attack', ['/SFX/fire_attack.mp3']); 
      this.scene.load.audio('moyaki_attack', ['/SFX/fire_attack.mp3']); 
      
      // Special attack sounds
      this.scene.load.audio('ice_attack', ['/SFX/fire_attack.mp3']); 
      this.scene.load.audio('fire_attack', ['/SFX/fire_attack.mp3']); 
      this.scene.load.audio('explosion_sound', ['/SFX/fire_attack.mp3']); 
      this.scene.load.audio('freeze_sound', ['/SFX/fire_attack.mp3']); 
      
      // Win/lose sounds
      this.scene.load.audio('victory', ['/SFX/you_win.mp3']);
      this.scene.load.audio('game_over', ['/SFX/enemy_defeat.mp3']);
      this.scene.load.audio('game_over_sting', ['/SFX/enemy_defeat.mp3']); // Alias for game_over
